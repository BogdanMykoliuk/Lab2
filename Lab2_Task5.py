class Group:
    """
    Class, instance of which contains a sequence of instances of the class Student
    """
...
Bogdan = Student('Bogdan', 'Mukoliuk', 'NT032480', 5, 5, 5, 4, 5)
John = Student('John', 'Bobus', 'NT032460', 1, 2, 2, 4, 5)
Andrew = Student('Andrew', 'Abobovich', 'NT032450', 3, 3, 3, 4, 5)
Ivan = Student('Ivan', 'Kuruch', 'NT032440', 1, 1, 1, 4, 5)
Vanya = Student('Vanya', 'Nosov', 'NT032430', 2, 2, 3, 4, 5)
Denis = Student('Denis', 'Vivdenko', 'NT032420', 1, 2, 5, 4, 5)
Roma = Student('Roma', 'Loving', 'NT032410', 1, 4, 4, 4, 5)
Vova = Student('Vova', 'Krutivolova', 'NT032489', 1, 2, 3, 4, 5)

if __name__ == '__main__':
    tv = Group('TV-12', Bogdan, Ivan, Vanya, John, Andrew, Roma, Denis)
    tv.add_student(Vova)
